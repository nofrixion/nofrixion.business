    ...
    >
      <div className="[&>*]:border-b [&>*]:border-solid [&>*]:border-b-borderGrey">
        ...
        <div className="py-6 md:py-4">
          <Switch iconName="bank/24" label="Pay by Bank" value={isBankEnabled} onChange={setIsBankEnabled} />
        ...
        <div className="py-6 md:py-4">
          <Switch iconName="card/24" label="Credit and debit card" value={isCardEnabled} onChange={setIsCardEnabled} />
