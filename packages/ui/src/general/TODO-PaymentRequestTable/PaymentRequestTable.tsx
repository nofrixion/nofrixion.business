...
import PaymentRequestRow from "../TODO-PaymentRequestRow";
import ColumnHeader, { SortDirection } from "../ColumnHeader";
import { LocalPaymentRequest } from "../../utils/localTypes";
import { Toaster } from "../TODO-Toast";

import EmptyState from "./TODO-EmptyState";
import PaymentRequestMobileCard from "../TODO-PaymentRequestMobileCard";
    ...
    <>
      ...
      {(isLoading || (paymentRequests && paymentRequests.length > 0)) && (
        <table className="hidden lg:table table-fixed text-left w-full">
          ...
          <thead>
            <tr>
              <th className={cn(commonThClasses, "w-44 text-left")}>
                <ColumnHeader
                  label="Status"
              ...
              <th className={cn(commonThClasses, "w-44 text-right pr-0")}>
                <ColumnHeader
                  label="Amount"
